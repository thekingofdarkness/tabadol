            ...
            <div class="form_container">
                ...
                <form method="POST" action="{{ route('login.process') }}">
                    ...
                    <div class="title_container">
                        ...
                        <span class="subtitle">سجل الدخول إلى حسابك باستعمال البريد الالكتروني الذي قمت بإستعماله في إنشاء
                            حسابك
                            أو رقم الهاتف، وكلمة السر التي اخترتها</span>
                    </div>
                    @if ($errors->any())
                    ...
                    <div class="input_container">
                        ...
                        <label class="input_label" for="email_field">البريد الالكتروني - أو - رقم الهاتف :</label>
                        ...
                        <input placeholder="exemple@mail.com" title="Inpit title" name="login" type="text"
                            class="input_field mb-2 mt-2" id="email_field" value="{{ old('login') }}" required>
                        @error('login')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                    <div class="input_container">
                        <label class="input_label" for="password_field">كلمة السر</label>
                        <svg fill="none" viewBox="0 0 24 24" height="24" width="24"
                            xmlns="http://www.w3.org/2000/svg" class="icon">
                        ...
                        <input placeholder="Password" title="Inpit title" name="password" type="password"
                            class="input_field mb-2 mt-2" id="password_field" required>
                        @error('password')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                    <button title="Sign In" type="submit" class="sign-in_btn mb-2">
                        <span>تسجيل الدخول</span>
                    </button>

                    <a href="{{route('password.forgot')}}" class="link-primary fw-bold">هل نسيت كلمة السر الخاصة بك ؟</a>
                    <div class="separator">
                        <hr class="line">
                        <span>أو</span>
                        <hr class="line">
                ...
                <a href="{{ route('register') }}" class="sign-in_ggl">
